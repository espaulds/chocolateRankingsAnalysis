...
public class ChocolateRatingsCode {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ArrayList<String> questionOneColAL = parseCSVCol("/Users/espaulding/Desktop/chocolateRatingsAnalysis/ChocolateDataSet.csv", questionOneCol); //testValues
        System.out.println(questionOneColAL);
        ArrayList<String> questionOneColALND = getRidOfDuplicates(questionOneColAL); //noDuplicates
        System.out.println(questionOneColALND);
        ArrayList<Integer> questionOneCounts = counts(questionOneColAL); //counts
        System.out.println(questionOneCounts);
        ArrayList<Double> questionOneTotRatings = totRatings(questionOneColAL, ratings); //totRatings
        System.out.println(questionOneTotRatings);
        ...
        System.out.println(questionOneAverageRatings);
        ...
        ArrayList<Integer> questionOneCounts = counts(questionOneColAL);
        ArrayList<Double> questionOneTotRatings = totRatings(questionOneColAL, ratings);
    ...
    public static ArrayList<Double> parseCSVRatings(String filename) throws FileNotFoundException {
        ...
        while(key.hasNextLine() == true){
            ...
            count++;
            System.out.println(alOfLine.get(index));
